...
- Isolated authentication and data model for GSP.NET.
...
2. Set GSP.NET Supabase project values.
3. Serve this folder using any static server.
4. Open `login.html`.

## Supabase Setup

1. Create a new Supabase project for GSP.NET.
2. Run SQL in `sql/001_vsl_schema.sql`.
3. Configure Auth redirect URLs:
   - `https://gspnet.ug/login.html`
   - `https://gspnet.ug/webmap.html`
